...
is thoroughly tested, is faster at scale, and it has a more generic and user-friendly API.
...
\item[\indent\faWrench] \cvtag{C / C++} \cvtag{Git} \cvtag{GitHub Actions}
\item[\indent\faLightbulbO] \cvtag{Algorithm Engineering} \cvtag{Model Checking}
  \cvtag{I/O-efficiency}
  % \cvtag{Game Theory}
\end{enumerate}
